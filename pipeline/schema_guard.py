#!/usr/bin/env python3
"""이미지 안의 모델 코드와 DB 의 스키마가 같은 판인지, **DB 를 만지기 전에** 본다 (198).

    import schema_guard
    schema_guard.check_or_exit("segment_diatoms")     # 어긋나면 SystemExit(3)
